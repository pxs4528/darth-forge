...
## 6. Set up automated deployments (GitHub webhook)
...
## 8. Put Cloudflare back in front (recommended)
...
## 9. CI/CD is now automated

GitHub Actions automatically builds and deploys on every push to main. No manual action needed — just push and it's deployed to the VPS within a few seconds.
