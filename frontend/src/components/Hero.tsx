        ...
        <div class="terminal-window p-6 mb-6 space-y-4">
          <div>
            ...
            <div class="ml-4 mt-2 space-y-2">
              <div class="text-white">Parth Sharma</div>
              <div class="text-white">→ Software Engineer @ General Motors</div>
              <div class="text-white">→ B.S. Computer Science, UT Arlington</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="ml-4 mt-2 space-y-2">
              <div class="text-white">→ Full-Stack Development (Next.js, React, Go, C#)</div>
              <div class="text-white">→ Distributed Systems & Autonomous Robotics</div>
